...
def prepare_deepmind(d_path):
    ...
    train_xy_list = load_lines(d_path, "sentence_train.txt", configs)

    print("dump train...")

    pickle.dump(train_xy_list, open(TRAINING_PATH + "sentence_train.pkl", "wb"), protocol=pickle.HIGHEST_PROTOCOL)
...
if __name__ == "__main__":
    ...
    parser.add_argument("-d", "--data", default="wikipedia", help="dataset path", )
